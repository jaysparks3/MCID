...
Hips_9_21_23 <- read_csv ("G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/Hips_9_21_23_raw.csv" )
...
```{r message=FALSE, warning=FALSE}
library(tidyverse)
my_womac <- read_csv("G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_womac_items2_cleaned_master.csv")
...
write.csv(hips_wide_df_master_cal2, "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_wide_df_master.csv", row.names = FALSE)
...
write.csv(tab1 , "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_mean_diff_by_intervals.csv")
...
write.csv(hips_interval_tukeyst_results , "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_interval_tukeyst_results_final.csv")
...
write.csv(hips_demo_tukeyst_results , "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_demo_tukeyst_results_final.csv")
...
write.csv(df, "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_roc_analysis_mcid_final.csv",row.names = FALSE)
...
df_cases
write.csv(df_cases, "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_roc_cases_final.csv",row.names = FALSE)
# Plot the ROC curve
...
df_cases <- data.frame(coords(roc_curve, transpose=FALSE))  
 # write.csv(df_cases, "G:/Shared drives/HMCSE-PAM Lab/Jay's Space/2023 Active Projects/08/Regenative Labs 2023/hips_roc_cases_test.csv",row.names = FALSE)
# Plot the ROC curve
plot(roc_curve, print.thres = "best", print.thres.best.method = "youden")
roc(response = true_labels, predictor = prob_improved, plot=TRUE, print.auc =TRUE)
df_cases
